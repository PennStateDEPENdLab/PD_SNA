*code originally written by Jennifer Morse and editted by Kimberly Nolf in 9/2008 for use with Emotion IFB data.  The code will recode all variables from string to 
*numeric (data pulled from MediaLab will be catergorized as string), recode all variable item scores to match original questionnaire, and compute PD scores.  

*changes string variables to numeric variables.
ALTER TYPE iip1 to iip90 (F2.0) .
execute .
...
*recodes data in order to match questionniare data (zero is not a valid scale response value in medialab).
RECODE
iip1 to iip90 
(1=0) (2=1) (3=2) (4=3) (5=4) .
EXECUTE .
...
COMPUTE SumValue = SUM.80(iip1,iip2,iip3,iip4,iip5,iip6,iip7,iip8,iip9,iip10,iip11,iip12,iip13,iip14,iip15,iip16,iip17,iip18
